...
/*___________________________________________________________________________
 ...
 |   bit number:                                                             |
 |               roundX(L_var1) = extract_h(L_add(L_var1,32768))              |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |            mac_r(L_var3,var1,var2) = roundX(L_mac(L_var3,var1,var2))       |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |            msu_r(L_var3,var1,var2) = roundX(L_msu(L_var3,var1,var2))      |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
